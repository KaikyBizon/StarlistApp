...
function SobreNos(){
    ...
    <section id="sobre">
        <h1 id="sobre-txt">O Starlist é uma lista de tarefas práticas que te ajuda no seu planejamento,
            organização e gerenciamento das suas ideias
            que tem como principal foco te ajudar a aproveitar melhor seu tempo. Venha fazer parte de nossa
            constelação.</h1>
    </section>
